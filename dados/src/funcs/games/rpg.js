...
async function processarComandoRPG(senderId, command, args, pushname, funcoesExternas = {}) {
    ...
    try {
        ...
        if (command === "ajuda" || command === "help" || command === "comandos") {
            // TODO: Implementar um sistema de ajuda específico do RPG?
        ...
        switch (command) {
            ...
            case "plantar":
            case "farm":
                // Precisa de mais lógica (escolher semente, etc.)
                return { msg: "Sistema de plantação em desenvolvimento." };
            case "cortar":
            case "chop":
            case "lenhar":
            ...
            case "alimentar":
            case "feed":
                // Precisa de mais lógica (escolher pet, item)
                return { msg: "Sistema de pets em desenvolvimento." };
            ...
            case "pvp":
                ...
                switch (subComandoPvP) {
                    ...
                    default:
                        return { msg: "Subcomando PvP inválido. Use: desafiar, aceitar, recusar..." };
                }
