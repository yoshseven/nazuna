...
const GERAL = {
    ...
    ATIVAR_MSG_BEM_VINDO: false,
    // Modo de depuração para logs detalhados e funcionalidades de teste
    DEBUG_MODE: false, 
};
...
const DIFICULDADE = {
    ...
    // Configurações de Pets (Adicionadas na Fase 2)
    PET_NIVEL_MAXIMO: 50, // Nível máximo que um pet pode alcançar
    PET_FELICIDADE_GANHO_COMIDA: 20, // Ganho de felicidade ao alimentar
    PET_XP_GANHO_COMIDA: 15, // Ganho de XP ao alimentar
    PET_INTERACT_COOLDOWN_SECONDS: 6 * 60 * 60, // Cooldown para interação (6 horas)
    PET_FELICIDADE_GANHO_INTERACAO: 10, // Ganho de felicidade ao interagir
    PET_XP_GANHO_INTERACAO: 5, // Ganho de XP ao interagir

    // Configurações de Relacionamentos (Adicionadas na Fase 2)
    AFINIDADE_GANHO_CONVERSA: 2, // Afinidade ganha por conversa
    AFINIDADE_GANHO_PRESENTE_FAVORITO: 50, // Afinidade por presente favorito
    AFINIDADE_PERDA_PRESENTE_ODIADO: -25, // Perda de afinidade por presente odiado
    AFINIDADE_GANHO_PRESENTE_COMUM: 10, // Afinidade por presente comum
};
...
const ITENS_LOJA = [
    ...
    { nome: 'lobo', preco: Math.floor(2000 * DIFICULDADE.SHOP_COST_MULTIPLIER), venda: 800, tipo: "pet", bonus: { caca: 0.2 }, nomeExibicao: 'Lobo' },
    { nome: 'falcao', preco: Math.floor(2500 * DIFICULDADE.SHOP_COST_MULTIPLIER), venda: 1000, tipo: "pet", bonus: { missaoDelay: 0.9 }, nomeExibicao: 'Falcão' },
    { nome: 'dragao bebe', preco: Math.floor(5000 * DIFICULDADE.SHOP_COST_MULTIPLIER), venda: 2000, tipo: "pet", bonus: { batalhaDano: 10 }, nomeExibicao: 'Dragão Bebê' }
];
...
const VALORES_INICIAIS_JOGADOR = {
    ...
    stats: { hp_max: 100, ataque: 10, defesa: 5, velocidade: 10 }, // HP movido para status, hp_max mantido
    status: { hp: 100, fadiga: 0, moral: 100 }, // HP adicionado para consistência com player.js
