...
📹 *Enviando seu vídeo, aguarde!*`;
  ...
  case 'menulogo': case 'menulogos': case 'logos': case 'logomenu':
    try {
      await nazu.react(['🔄']);
      await sendMenuWithMedia('logos', menuLogos);
    } catch (error) {
      console.error('Erro ao enviar menu de alteradores:', error);
      await reply("❌ Ocorreu um erro ao carregar o menu de alteradores");
    }
...
${weatherEmoji} *${weatherDescription}*`;
 ...
 //COMANDOS DE LOGOS
    case 'neon':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}neon texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo neon, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'neon' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Neon`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
    }
    break;

  case 'matrix':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}matrix texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo matrix, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'matrix' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Matrix`
      }, { quoted: info });
  ...
  case 'glow':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}glow texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo glow, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'glow' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Glow`
      }, { quoted: info });
  ...
  case 'glow-advanced':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}glow-advanced texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo glow avançado, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'glow-advanced' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Glow Avançado`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'dropwater':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}dropwater texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo dropwater, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'dropwater' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Dropwater`
      }, { quoted: info });
  ...
  case 'glitch':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}glitch texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo glitch, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'glitch' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Glitch`
      }, { quoted: info });
  ...
  case 'glitch-tik-tok':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}glitch-tik-tok texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo glitch TikTok, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'glitch-tik-tok' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Glitch TikTok`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'harry-potter':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}harry-potter texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Harry Potter, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'harry-potter' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Harry Potter`
      }, { quoted: info });
  ...
  case 'blackpink':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}blackpink texto`);
      nazu.react('💗');
      reply("⏳ Gerando logo Blackpink, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'blackpink' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Blackpink`
      }, { quoted: info });
  ...
  case 'blackpink-roses':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}blackpink-roses texto`);
      nazu.react('💗');
      reply("⏳ Gerando logo Blackpink Roses, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'blackpink-roses' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Blackpink Roses`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'blackpink-style':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}blackpink-style texto`);
      nazu.react('💗');
      reply("⏳ Gerando logo Blackpink Style, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'blackpink-style' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Blackpink Style`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'blackpink-neon':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}blackpink-neon texto`);
      nazu.react('💗');
      reply("⏳ Gerando logo Blackpink Neon, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'blackpink-neon' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Blackpink Neon`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'thunder':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}thunder texto`);
      nazu.react('⚡');
      reply("⏳ Gerando logo Thunder, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'thunder' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Thunder`
      }, { quoted: info });
  ...
  case 'thunder-generator':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}thunder-generator texto`);
      nazu.react('⚡');
      reply("⏳ Gerando logo Thunder Generator, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'thunder-generator' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Thunder Generator`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'green-horror':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}green-horror texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Green Horror, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'green-horror' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Green Horror`
      }, { quoted: info });
  ...
  case 'wolf-black-bear':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}wolf-black-bear texto`);
      nazu.react('🐺');
      reply("⏳ Gerando logo Wolf Black Bear, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'wolf-black-bear' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Wolf Black Bear`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'wolf-galaxy':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}wolf-galaxy texto`);
      nazu.react('🐺');
      reply("⏳ Gerando logo Wolf Galaxy, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'wolf-galaxy' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Wolf Galaxy`
      }, { quoted: info });
  ...
  case 'wolf-black':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}wolf-black texto`);
      nazu.react('🐺');
      reply("⏳ Gerando logo Wolf Black, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'wolf-black' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Wolf Black`
      }, { quoted: info });
  ...
  case 'ninja':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}ninja texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Ninja, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'ninja' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Ninja`
      }, { quoted: info });
  ...
  case 'pornhub':
    try {
      ...
      if (splitText.length !== 2) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}pornhub texto1/texto2`);
      nazu.react('🔞');
      reply("⏳ Gerando logo Pornhub, aguarde...");
      const text1 = splitText[0];
      const text2 = splitText[1];
      const result = await imageCustom.textpro([text1, text2], { type: 'pornhub' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto 1:* ${text1}\n*Texto 2:* ${text2}\n*Estilo:* Pornhub`
      }, { quoted: info });
  ...
  case 'marvel-studios':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}marvel-studios texto`);
      nazu.react('🦸‍♂️');
      reply("⏳ Gerando logo Marvel Studios, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'marvel-studios' });
      await nazu.sendMessage(from, { 
        image: { url: result },
  ...
  case 'marvel-studios-metal':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}marvel-studios-metal texto`);
      nazu.react('🦸‍♂️');
      reply("⏳ Gerando logo Marvel Studios Metal, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'marvel-studios-metal' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Marvel Studios Metal`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'marvel-avengers':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}marvel-avengers texto`);
      nazu.react('🦸‍♂️');
      reply("⏳ Gerando logo Marvel Avengers, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'marvel-avengers' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Marvel Avengers`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'marvel-thor':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}marvel-thor texto`);
      nazu.react('🦸‍♂️');
      reply("⏳ Gerando logo Marvel Thor, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'marvel-thor' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Marvel Thor`
      }, { quoted: info });
  ...
  case 'deep':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}deep texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Deep, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'deep' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Deep`
      }, { quoted: info });
  ...
  case 'transformer':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}transformer texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Transformer, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'transformer' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Transformer`
      }, { quoted: info });
  ...
  case '8-bit':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}8-bit texto`);
      nazu.react('🎮');
      reply("⏳ Gerando logo 8-Bit, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: '8-bit' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* 8-Bit`
      }, { quoted: info });
  ...
  case 'retro-neon':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}retroneon texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Retro Neon, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'retro-neon' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Retro Neon`
      }, { quoted: info });
  ...
  case 'cartoon':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}cartoon texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Cartoon, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'cartoon' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Cartoon`
      }, { quoted: info });
  ...
  case 'shiny':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}shiny texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Shiny, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'shiny' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Shiny`
      }, { quoted: info });
  ...
  case 'chrome':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}chrome texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Chrome, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'chrome' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Chrome`
      }, { quoted: info });
  ...
  case 'hologram':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}hologram texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Hologram, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'hologram' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Hologram`
      }, { quoted: info });
  ...
  case 'rainbow':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}rainbow texto`);
      nazu.react('🌈');
      reply("⏳ Gerando logo Rainbow, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'rainbow' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Rainbow`
      }, { quoted: info });
  ...
  case 'wall':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}wall texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Wall, aguarde...");
      const text = q;
      const result = await imageCustom.textpro(text, { type: 'wall' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Wall`
      }, { quoted: info });
  ...
  case 'neonphoto':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}neonphoto texto`);
      nazu.react('📸');
      reply("⏳ Gerando logo Neon Photo, aguarde...");
      const text = q;
      const result = await imageCustom.protooxy(text, { type: 'neon' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Neon Photo`
      }, { quoted: info });
  ...
  case 'neon-dark':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}neon-dark texto`);
      nazu.react('📸');
      reply("⏳ Gerando logo Neon Dark, aguarde...");
      const text = q;
      const result = await imageCustom.protooxy(text, { type: 'neon-dark' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Neon Dark`
      }, { quoted: info });
  ...
  case 'warface':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}warface texto`);
      nazu.react('🎮');
      reply("⏳ Gerando logo Warface, aguarde...");
      const text = q;
      const result = await imageCustom.protooxy(text, { type: 'warface' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Warface`
      }, { quoted: info });
  ...
  case 'overwatch':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}overwatch texto`);
      nazu.react('🎮');
      reply("⏳ Gerando logo Overwatch, aguarde...");
      const text = q;
      const result = await imageCustom.protooxy(text, { type: 'overwatch' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Overwatch`
      }, { quoted: info });
  ...
  case 'csgo':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}csgo texto`);
      nazu.react('🎮');
      reply("⏳ Gerando logo CS:GO, aguarde...");
      const text = q;
      const result = await imageCustom.protooxy(text, { type: 'cs' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* CS:GO`
      }, { quoted: info });
  ...
  case 'pubg':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}pubg texto`);
      nazu.react('🎮');
      reply("⏳ Gerando logo PUBG, aguarde...");
      const text = q;
      const result = await imageCustom.protooxy(text, { type: 'pubg' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* PUBG`
      }, { quoted: info });
  ...
  case 'battlefield':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}battlefield texto`);
      nazu.react('🎮');
      reply("⏳ Gerando logo Battlefield, aguarde...");
      const text = q;
      const result = await imageCustom.protooxy(text, { type: 'battlefield' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Battlefield`
      }, { quoted: info });
  ...
  case 'flaming':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}flaming texto`);
      nazu.react('🔥');
      reply("⏳ Gerando logo Flaming, aguarde...");
      const text = q;
      const result = await imageCustom.protooxy(text, { type: 'flaming' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Flaming`
      }, { quoted: info });
  ...
  case 'cross-fire':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}cross-fire texto`);
      nazu.react('🎮');
      reply("⏳ Gerando logo Cross Fire, aguarde...");
      const text = q;
      const result = await imageCustom.protooxy(text, { type: 'cross-fire' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Cross Fire`
      }, { quoted: info });
  ...
  case 'google':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}google texto`);
      nazu.react('🌐');
      reply("⏳ Gerando logo Google, aguarde...");
      const text = q;
      const result = await imageCustom.protooxy(text, { type: 'google' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Google`
      }, { quoted: info });
  ...
  case 'glitch-ephoto':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}glitch-ephoto texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Glitch, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'glitch' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Glitch`
      }, { quoted: info });
  ...
  case 'galaxy':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}galaxy texto`);
      nazu.react('🌌');
      reply("⏳ Gerando logo Galaxy, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'galaxy' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Galaxy`
      }, { quoted: info });
  ...
  case 'galaxy-light':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}galaxy-light texto`);
      nazu.react('🌌');
      reply("⏳ Gerando logo Galaxy Light, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'galaxy-light' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Galaxy Light`
      }, { quoted: info });
  ...
  case 'glossy':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}glossy texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Glossy, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'glossy' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Glossy`
      }, { quoted: info });
  ...
  case 'metallic':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}metallic texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Metallic, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'metallic' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Metallic`
      }, { quoted: info });
  ...
  case 'graffiti':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}graffiti texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Graffiti, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'graffiti' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Graffiti`
      }, { quoted: info });
  ...
  case 'mascote':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}mascote texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Mascote, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'mascote' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Mascote`
      }, { quoted: info });
  ...
  case 'retro':
    try {
      const splitText = q.split('/');
      if (splitText.length < 1 || splitText.length > 3) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}retro texto1[/texto2/texto3]`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Retro, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'retro' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text.replace('/', ' + ')}\n*Estilo:* Retro`
      }, { quoted: info });
  ...
  case 'deadpool':
    try {
      const splitText = q.split('/');
      if (splitText.length !== 2) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}deadpool texto1/texto2`);
      nazu.react('🦸‍♂️');
      reply("⏳ Gerando logo Deadpool, aguarde...");
      const text1 = splitText[0];
      const text2 = splitText[1];
      const result = await imageCustom.ephoto([text1, text2], { type: 'deadpool' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto 1:* ${text1}\n*Texto 2:* ${text2}\n*Estilo:* Deadpool`
      }, { quoted: info });
  ...
  case 'vintage3d':
    try {
      const splitText = q.split('/');
      if (splitText.length !== 2) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}vintage3d texto1/texto2`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Vintage 3D, aguarde...");
      const text1 = splitText[0];
      const text2 = splitText[1];
      const result = await imageCustom.ephoto([text1, text2], { type: 'vintage3d' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto 1:* ${text1}\n*Texto 2:* ${text2}\n*Estilo:* Vintage 3D`
      }, { quoted: info });
  ...
  case 'goldpink':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}goldpink texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Gold Pink, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'goldpink' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Gold Pink`
      }, { quoted: info });
  ...
  case 'dragonfire':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}dragonfire texto`);
      nazu.react('🔥');
      reply("⏳ Gerando logo Dragon Fire, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'dragonfire' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Dragon Fire`
      }, { quoted: info });
  ...
  case 'newyear':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}newyear texto`);
      nazu.react('🎬');
      reply("⏳ Gerando logo em vídeo de Ano Novo, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'newyear' });
      await nazu.sendMessage(from, { 
        video: { url: result },
        caption: `🎥 *Logo em vídeo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Ano Novo`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo em vídeo. Tente novamente mais tarde.");
    }
    break;

  case 'tiger':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}tiger texto`);
      nazu.react('🐯');
      reply("⏳ Gerando logo Tiger em vídeo, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'tiger' });
      await nazu.sendMessage(from, { 
        video: { url: result },
        caption: `🎥 *Logo em vídeo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Tiger`
      }, { quoted: info });
  ...
  case 'pubgvideo':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}pubgvideo texto`);
      nazu.react('🎮');
      reply("⏳ Gerando logo PUBG em vídeo, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'pubgvideo' });
      await nazu.sendMessage(from, { 
        video: { url: result },
        caption: `🎥 *Logo em vídeo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* PUBG Video`
      }, { quoted: info });
  ...
  case 'pubgavatar':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}pubgavatar texto`);
      nazu.react('🎮');
      reply("⏳ Gerando logo PUBG Avatar, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'pubgavatar' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* PUBG Avatar`
      }, { quoted: info });
  ...
  case 'comics':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}comics texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Comics, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'comics' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Comics`
      }, { quoted: info });
  ...
  case 'amongus':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}amongus texto`);
      nazu.react('🎮');
      reply("⏳ Gerando logo Among Us, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'amongus' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Among Us`
      }, { quoted: info });
  ...
  case 'ffavatar':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}ffavatar texto`);
      nazu.react('🎮');
      reply("⏳ Gerando logo Free Fire Avatar, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'ffavatar' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Free Fire Avatar`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'lolavatar':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}lolavatar texto`);
      nazu.react('🎮');
      reply("⏳ Gerando logo League of Legends Avatar, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'lolavatar' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* League of Legends Avatar`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'cemiterio':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}cemiterio texto`);
      nazu.react('🎃');
      reply("⏳ Gerando logo Cemitério, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'cemiterio' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Cemitério`
      }, { quoted: info });
  ...
  case 'hallobat':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}hallobat texto`);
      nazu.react('🎃');
      reply("⏳ Gerando logo Halloween Bats, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'hallobat' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Halloween Bats`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'blood':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}blood texto`);
      nazu.react('🩸');
      reply("⏳ Gerando logo Blood, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'blood' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Blood`
      }, { quoted: info });
  ...
  case 'halloween':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}halloween texto`);
      nazu.react('🎃');
      reply("⏳ Gerando logo Halloween, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'halloween' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Halloween`
      }, { quoted: info });
  ...
  case 'titanium':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}titanium texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Titanium, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'titanium' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Titanium`
      }, { quoted: info });
  ...
  case 'sunset':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}sunset texto`);
      nazu.react('🌅');
      reply("⏳ Gerando logo Sunset, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'sunset' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Sunset`
      }, { quoted: info });
  ...
  case 'snow':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}snow texto`);
      nazu.react('❄️');
      reply("⏳ Gerando logo Snow, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'snow' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Snow`
      }, { quoted: info });
  ...
  case 'america':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}america texto`);
      nazu.react('🇺🇸');
      reply("⏳ Gerando logo America, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'america' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* America`
      }, { quoted: info });
  ...
  case 'eraser':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}eraser texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Eraser, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'eraser' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Eraser`
      }, { quoted: info });
  ...
  case 'captain':
    try {
      const splitText = q.split('/');
      if (splitText.length !== 2) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}captain texto1/texto2`);
      nazu.react('🦸‍♂️');
      reply("⏳ Gerando logo Captain America, aguarde...");
      const text1 = splitText[0];
      const text2 = splitText[1];
      const result = await imageCustom.ephoto([text1, text2], { type: 'captain' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto 1:* ${text1}\n*Texto 2:* ${text2}\n*Estilo:* Captain America`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'mascoteneon':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}mascoteneon texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Mascote Neon, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'mascoteneon' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Mascote Neon`
      }, { quoted: info });
  ...
  case 'phlogo':
    try {
      const splitText = q.split('/');
      if (splitText.length !== 2) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}phlogo texto1/texto2`);
      nazu.react('🔞');
      reply("⏳ Gerando logo Pornhub, aguarde...");
      const text1 = splitText[0];
      const text2 = splitText[1];
      const result = await imageCustom.ephoto([text1, text2], { type: 'phlogo' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto 1:* ${text1}\n*Texto 2:* ${text2}\n*Estilo:* Pornhub`
      }, { quoted: info });
  ...
  case 'doubleexposure':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}doubleexposure texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Double Exposure, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'doubleexposure' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Double Exposure`
      }, { quoted: info });
    } catch (e) {
      console.error(e);
      await reply("❌ Ocorreu um erro ao gerar a logo. Tente novamente mais tarde.");
  ...
  case 'metal':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}metal texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo Metal, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'metal' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Metal`
      }, { quoted: info });
  ...
  case '3dcrack':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}3dcrack texto`);
      nazu.react('🎨');
      reply("⏳ Gerando logo 3D Crack, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: '3dcrack' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* 3D Crack`
      }, { quoted: info });
  ...
  case 'multicolor':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}multicolor texto`);
      nazu.react('🌈');
      reply("⏳ Gerando logo Multicolor, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'multicolor' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Multicolor`
      }, { quoted: info });
  ...
  case 'balloon':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}balloon texto`);
      nazu.react('🎈');
      reply("⏳ Gerando logo Balloon, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'balloon' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Balloon`
      }, { quoted: info });
  ...
  case 'colorful':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}colorful texto`);
      nazu.react('🌈');
      reply("⏳ Gerando logo Colorful, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'colorful' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Colorful`
      }, { quoted: info });
  ...
  case 'frozen':
    try {
      if (!q) return reply(`❌ Formato incorreto!\n\nUso correto: ${prefix}frozen texto`);
      nazu.react('❄️');
      reply("⏳ Gerando logo Frozen, aguarde...");
      const text = q;
      const result = await imageCustom.ephoto(text, { type: 'frozen' });
      await nazu.sendMessage(from, { 
        image: { url: result },
        caption: `🖼️ *Logo criada com sucesso!*\n\n*Texto:* ${text}\n*Estilo:* Frozen`
      }, { quoted: info });
